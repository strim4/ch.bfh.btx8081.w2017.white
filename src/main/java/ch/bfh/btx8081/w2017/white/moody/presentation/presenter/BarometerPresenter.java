...
/**
 * This class is the presenter of the Barometer screen. On this screen the user
 * can answer to his daly questions and can see his statistic of given answers
 * during 1 month 6 month or a year
 * 
...
public class BarometerPresenter implements ViewListener {
	...
	/**
	 * Buttons for the statistic selection
	 * 
	 */
