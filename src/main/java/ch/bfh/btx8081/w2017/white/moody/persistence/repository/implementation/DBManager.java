...
//singleton pattern for DB Manager
	...
	/**
	 * 
	 * Method to select all diaryText Entries from the DB and returns a List containing all entries
	 * 
	 */
	...
	/**
	 * 
	 * Method to select all Profile Entries from the DB and returns a List containing all entries
	 * 
	 */
	...
	/**
	 * 
	 * Method to return the name attributs from all activitiyEntries for the dropdown activityentries. Methode returns an ArrayList containing the entries
	 * 
	 */
	...
	/**
	 * 
	 * Method to select all Activities Entries from the DB and returns a List containing all entries
	 * 
	 */
	...
	/**
	 * 
	 * Method to select all diaryPic Entries from the DB and returns a List containing all entries
	 * 
	 */
